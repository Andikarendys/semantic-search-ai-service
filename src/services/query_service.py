...
def save_query(db: Session, query: str, embedding, user_id: int, model_comparison: dict = None, algorithm: str = None):
  ...
  new_query = Query(
    ...
    algorithm=algorithm,   # [BARU] algoritma yang dipakai user
  )
  db.add(new_query)
  db.commit()
